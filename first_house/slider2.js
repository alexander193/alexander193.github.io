...
var WRAPPER_SELECTOR = ".slider2__wrapper",
	ITEMS_SELECTOR = ".slider2__items",
	ITEM_SELECTOR = ".slider2__item",
	CONTROL_CLASS = "slider2__control",
	SELECTOR_PREV = '.slider2__control[data-slide="prev"]',
	SELECTOR_NEXT = '.slider2__control[data-slide="next"]',
	SELECTOR_INDICATOR = ".slider2__indicators>li",
	slider2_TRANSITION_OFF = "slider2_disable-transition",
	CLASS_CONTROL_HIDE = "slider2__control_hide",
	CLASS_ITEM_ACTIVE = "slider2__item_active",
	CLASS_INDICATOR_ACTIVE = "active";

function Chiefslider2(t, i) {
...
Chiefslider2.prototype._addEventListener = function() {
	var t = this._$root,
		i = this._$items,
		e = this._config;
...
}, Chiefslider2.prototype.__refreshExtremeValues = function() {
...
}, Chiefslider2.prototype._balancingItems = function() {
...
}, Chiefslider2.prototype._setActiveClass = function() {
...
}, Chiefslider2.prototype._updateIndicators = function() {
...
}, Chiefslider2.prototype._move = function() {
...
}, Chiefslider2.prototype._moveToNext = function() {
	this._direction = "next", this._move()
}, Chiefslider2.prototype._moveToPrev = function() {
	this._direction = "prev", this._move()
}, Chiefslider2.prototype._moveTo = function(t) {
...
}, Chiefslider2.prototype._autoplay = function(t) {
...
}, Chiefslider2.prototype._refresh = function() {
	var t = this._$itemList,
		i = t[0].offsetWidth,
		e = this._$wrapper.offsetWidth,
		s = Math.round(e / i);
	if (s !== this._itemsInVisibleArea) {
		this._autoplay("stop"), this._$items.classList.add(slider2_TRANSITION_OFF), this._$items.style.transform = "translateX(0)", this._widthItem = i, this._widthWrapper = e, this._itemsInVisibleArea = s, this._transform = 0, this._transformStep = 100 / s, this._balancingItemsFlag = !1, this._activeItems = [];
		...
		if (this._setActiveClass(), window.requestAnimationFrame(function() {
				this._$items.classList.remove(slider2_TRANSITION_OFF)
...
}, Chiefslider2.prototype.next = function() {
	this._moveToNext()
}, Chiefslider2.prototype.prev = function() {
	this._moveToPrev()
}, Chiefslider2.prototype.moveTo = function(t) {
	this._moveTo(t)
}, Chiefslider2.prototype.refresh = function() {
	this._refresh()
};